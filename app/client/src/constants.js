...
angular
  ...
  .constant("DASHBOARD", {
    ...
    INCOMPLETE: `If you do not complete your application before ${deadline}, your registration is deemed to be incomplete!`,
    ...
    ADMITTED_AND_CAN_CONFIRM_TITLE: `You must confirm by ${deadline}.`,
    ADMITTED_AND_CANNOT_CONFIRM_TITLE: `Your confirmation deadline of ${deadline} has passed.`,
    ...
    CONFIRMED_NOT_PAST_TITLE: `You can edit your confirmation information until ${deadline}`,
    DECLINED:
      "We're sorry to hear that you won't be able to make it to ideate 2020! :(\nMaybe next year! We hope you see you again soon.",
  })
  .constant("TEAM", {
    NO_TEAM_REG_CLOSED:
      "Unfortunately, it's too late to enter with a team.\nHowever, you can still form teams on your own before or during the event!",
  });
